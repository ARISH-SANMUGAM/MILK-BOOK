      ...
      <div className="bg-white border-b border-slate-200 px-6 py-4 sticky top-0 z-50 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
           ...
           <motion.button 
             ...
             className="w-10 h-10 bg-slate-50 text-slate-500 rounded-full flex items-center justify-center border border-slate-100 shadow-sm transition-all active:bg-slate-100"
           >
             <User size={20} />
           </motion.button>
        </div>
            ...
            return (
                ...
                >
                   ...
                   <div className="grid grid-cols-2 divide-x divide-slate-100 bg-white">
                      ...
                      >
                         <MessageCircle size={16} fill="currentColor" className="opacity-80 group-hover/btn:scale-110 transition-transform" />
